...
# 
# Кроме того, судя по результатам проверки критерия Пирсона, метод, основанный на кумулятивной функции распределения, работает лучше: выборки, сгенерированные, с его использованием, прошли тесты на всех размерах, в отличие от сгенерированных "прямым" методом.
